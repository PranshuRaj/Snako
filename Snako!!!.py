...
intro = pygame.image.load("intro1.jpeg")
outro = pygame.image.load("outro111.jpg")
...
wishing.speak("Welcome to the game")
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_RETURN:
                    ...
                    if a <= 5:
                        ...
                        pygame.mixer.music.load('jarico.mp3')
                        pygame.mixer.music.fadeout(300)
                        pygame.mixer.music.play(100)
                        pygame.mixer.music.set_volume(.9)
                        gameloop()
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    exit_game = True
                    wishing.speak("hope you liked it")
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_RETURN:
                        welcome()
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_DOWN:
                        velocity_y = init_velocity
                        velocity_x = 0
                    if event.key == pygame.K_p:  # cheatcode
                        score += 10
            ...
            if head in snk_list[:-1]:
                ...
                pygame.mixer.music.load('Explosion.mp3.mp3')
                pygame.mixer.music.play(100)
    ...
    wishing.speak("hope you liked it")
    wishing.speak("Thanks for your valuable time")
